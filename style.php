<?php
  ...
  if (isset($_GET['edit']))
  {
    $id = $_GET['edit'];
    $edit_state = true;
    $rec = mysqli_query($conn, "SELECT * FROM style WHERE id=$id");
  ...
  <div class="container-fluid">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      if (isset($_GET["add"])) {
          ...
          Style successfully added!
          </div>";
      }
      elseif (isset($_GET["update"])) {
          echo "<div class='alert alert-success alert-dismissible'>
          <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
          Style successfully updated!
          </div>";
      }
    ...
    ?>
      ...
      <form method="post" action="includes/style.inc.php" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo $id; ?>">
      <div class="row">
         <div class="col-md-11 mb-3">
          <label for="style_name">Artstyle Name</label>
          <input type="text" class="form-control" name="style_name" id="style_name" value="<?php echo $style_name; ?>" required/>
        </div>
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="style.php?edit=<?php echo $row['id']; ?>">Edit</a></td>
              <td><a href="includes/style.inc.php?del=<?php echo $row['id']; ?>">Delete</a></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
